$( document ).ready(function () {
    ...
    function check_fname() {
        if (isName(firstname.value.trim()) == false) {
        ...
        else if (isEmpty(firstname.value.trim())) {
    ...
    function check_lname() {
        if (isName(lastname.value.trim()) == false) {
    ...
    function check_email() {
        if (isValidEmail(email.value.trim()) == false) {
        ...
        else if (isEmpty(email.value.trim())) {
            ...
            //console.log(isValidEmail(email.value.trim()));
            $("#emailError").hide();
    ...
    function check_password() {
        if (isValidPassword(password.value.trim()) == false) {
        ...
        else if (isEmpty(password.value.trim())) {
            ...
            //console.log(isValidPassword(password.value.trim()));
            $("#passwordError").hide();
